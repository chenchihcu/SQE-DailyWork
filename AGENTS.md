...
- **Coverage evidence chain**: `assert_coverage_baseline.py` PASS ≠ `-Profile Coverage` PASS; cite `scratch/verify-coverage-*-final*.log` (`EXIT:0`, full chain), not `coverage-summary.json` alone.
