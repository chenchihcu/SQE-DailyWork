...
_FIXED_MESSAGE_MAP = {
    ...
    "Batch quantity cannot be negative": "批量數不可為負數",
    "Defect quantity cannot be negative": "不良數不可為負數",
    "Defect quantity cannot exceed batch quantity": "不良數不可大於批量數",
    "Closed date must be YYYY-MM-DD": "結案日期格式需為 YYYY-MM-DD",
    "Closed date cannot be in the future": "結案日期不可晚於今天",
    "Closed date cannot be before anomaly date": "結案日期不可早於異常發生日",
    ...
    "Only closed anomalies can update closed date": "只有已結案異常可以調整結案日期",
