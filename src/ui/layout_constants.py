...
WORKBENCH_ROOT_CAUSE_DIALOG_PREFERRED_WIDTH = 820
WORKBENCH_ROOT_CAUSE_DIALOG_PREFERRED_HEIGHT = 640
WORKBENCH_ROOT_CAUSE_COMPACT_ADD_HEIGHT = 28
WORKBENCH_ACTION_DUE_DATE_WIDTH = 112
WORKBENCH_ACTION_OWNER_WIDTH = 96
WORKBENCH_ACTION_STATUS_WIDTH = 88
WORKBENCH_ACTION_TYPE_WIDTH = 120
WORKBENCH_ACTION_EDIT_WIDTH = 56
WORKBENCH_ACTION_FLOW_WIDTH = 168
# Table cell widget hosts (e.g. AnomalyActionTable edit/flow columns)
TABLE_CELL_WIDGET_H_MARGIN = 4
TABLE_CELL_WIDGET_V_HALF_MARGIN = 2
TABLE_CELL_WIDGET_V_MARGIN = TABLE_CELL_WIDGET_V_HALF_MARGIN * 2
TABLE_CELL_ACTION_MIN_HEIGHT = 40
WORKBENCH_ACTION_ROW_HEIGHT = (
    TABLE_CELL_WIDGET_V_MARGIN + TABLE_CELL_ACTION_MIN_HEIGHT
)
# Action dialog item rows (editable dialog widths; table uses WORKBENCH_ACTION_*)
ACTION_ITEM_INDEX_WIDTH = 28
ACTION_ITEM_DELETE_WIDTH = 52
ACTION_ITEM_OWNER_WIDTH = 112
ACTION_ITEM_DUE_DATE_WIDTH = 128
...
# 不良現象／現場照片雙欄比例（左 60% : 右 40%）
ANOMALY_PROBLEM_PHOTO_LEFT_STRETCH = 3
ANOMALY_PROBLEM_PHOTO_RIGHT_STRETCH = 2
WORKBENCH_OVERVIEW_THUMB_SIZE = 72
WORKBENCH_OVERVIEW_MAX_THUMBNAILS = 6
EVIDENCE_BULLET_PHOTO_BUTTON_WIDTH = 56
EVIDENCE_BULLET_THUMB_SIZE = 48
EVIDENCE_BULLET_MAX_PHOTOS_PER_ROW = 6
...
# 顯示設定全頁：內部分類導覽與雙欄內容在主視窗最小工作區中需可重排。
APPEARANCE_CATEGORY_RAIL_WIDTH = 160
...
# 資料庫設定主檔子群組 pill 標籤與並排按鈕列間距
SIDEBAR_MASTER_SUBGROUP_TOP_SPACING = 4
SIDEBAR_MASTER_SUBGROUP_LABEL_BOTTOM_SPACING = 2
SIDEBAR_MASTER_SUBGROUP_GAP = 6
...
# ActionItemListWidget row rhythm (must follow CONTROL_MIN_HEIGHT)
ACTION_ITEM_ROW_V_HALF_MARGIN = 4
ACTION_ITEM_ROW_V_MARGIN = ACTION_ITEM_ROW_V_HALF_MARGIN * 2
ACTION_ITEM_ROW_MIN_HEIGHT = CONTROL_MIN_HEIGHT
ACTION_ITEM_HEADER_GAP = 8
ACTION_ITEM_ROW_SPACING = 6
...
# 事件查詢 Quick Review（Master-Detail）版面契約
EVENT_LIST_QUICK_REVIEW_MIN_WIDTH = 360
EVENT_LIST_SPLITTER_LIST_STRETCH = 58
EVENT_LIST_SPLITTER_PREVIEW_STRETCH = 42
EVENT_LIST_PREVIEW_COLLAPSE_WIDTH = 1200
EVENT_LIST_PREVIEW_THUMB_SIZE = 62

# 供應商總覽異常重點欄位；摘要欄保留較寬空間供一眼判讀。
SUPPLIER_OVERVIEW_SUPPLIER_WIDTH = 150
SUPPLIER_OVERVIEW_COUNT_WIDTH = 78
SUPPLIER_OVERVIEW_ANOMALY_NO_WIDTH = 120
SUPPLIER_OVERVIEW_DATE_WIDTH = 96
SUPPLIER_OVERVIEW_CATEGORY_WIDTH = 115
SUPPLIER_OVERVIEW_SUMMARY_WIDTH = 260
SUPPLIER_OVERVIEW_DUE_DATE_WIDTH = 96
SUPPLIER_OVERVIEW_NCR_WIDTH = 96
SUPPLIER_OVERVIEW_STATUS_WIDTH = 78

MANAGER_SUMMARY_ANOMALY_NO_WIDTH = 106
MANAGER_SUMMARY_SUPPLIER_WIDTH = 110
MANAGER_SUMMARY_STATUS_WIDTH = 78
MANAGER_SUMMARY_DUE_DATE_WIDTH = 96
MANAGER_SUMMARY_QUALITY_WIDTH = 115
MANAGER_SUMMARY_UPDATED_WIDTH = 110
CASE_QUEUE_ANOMALY_NO_WIDTH = MANAGER_SUMMARY_ANOMALY_NO_WIDTH
CASE_QUEUE_SUPPLIER_WIDTH = MANAGER_SUMMARY_SUPPLIER_WIDTH
CASE_QUEUE_DUE_DATE_WIDTH = MANAGER_SUMMARY_DUE_DATE_WIDTH
CASE_QUEUE_RESPONSIBLE_WIDTH = MANAGER_SUMMARY_QUALITY_WIDTH
CASE_QUEUE_RCA_WIDTH = MANAGER_SUMMARY_QUALITY_WIDTH
OPERATIONAL_ACTION_QUEUE_ANOMALY_NO_WIDTH = 106
OPERATIONAL_ACTION_QUEUE_SUPPLIER_WIDTH = 110
OPERATIONAL_ACTION_QUEUE_TYPE_WIDTH = 96
OPERATIONAL_ACTION_QUEUE_DUE_DATE_WIDTH = 96
OPERATIONAL_ACTION_QUEUE_STATUS_WIDTH = 78
...
# NCR 清單完整欄位模式下的 preferred 最小寬度（Interactive 欄寬下限）
NCR_LIST_PREFERRED_DEFECT_NO_WIDTH = 140
NCR_LIST_PREFERRED_EVENT_DATE_WIDTH = 100
NCR_LIST_PREFERRED_PROCESSING_LINE_WIDTH = 110
NCR_LIST_PREFERRED_RETURN_SLIP_TYPE_WIDTH = 120
NCR_LIST_PREFERRED_WORK_ORDER_WIDTH = 140
NCR_LIST_PREFERRED_INTERNAL_WORK_ORDER_WIDTH = 140
NCR_LIST_PREFERRED_TRANSFER_SLIP_WIDTH = 140
NCR_LIST_PREFERRED_ITEM_NO_WIDTH = 120
NCR_LIST_PREFERRED_PRODUCT_NAME_WIDTH = 200
NCR_LIST_PREFERRED_DESCRIPTION_WIDTH = 320
NCR_PAGE_MARGIN = 8
...
# ---------------------------------------------------------------------------
# 對話框固定 header 高度（用於帶固定標題列的對話框，例如部分 modal header）
...
CLOSE_DIALOG_ATTACHMENT_SCROLL_MAX_HEIGHT = 320

# 全域搜尋對話框
GLOBAL_SEARCH_DIALOG_MIN_WIDTH = 620
GLOBAL_SEARCH_DIALOG_MARGINS = (18, 16, 18, 14)
GLOBAL_SEARCH_DIALOG_SPACING = 8

# 查詢型頁面（供應商總覽 / 360 等）根版面間距
QUERY_WORKFLOW_PAGE_SPACING = 10
