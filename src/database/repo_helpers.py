...
CASE_ACTION_TYPE_CORRECTION = "CORRECTION"
CASE_ACTION_TYPE_CORRECTIVE_ACTION = "CORRECTIVE_ACTION"
CASE_ACTION_TYPE_SYSTEMIC_IMPROVEMENT = "SYSTEMIC_IMPROVEMENT"
CASE_ACTION_TYPES: tuple[str, ...] = (
...
CASE_ACTION_TYPE_LABELS: dict[str, str] = {
    CASE_ACTION_TYPE_NEXT_ACTION: "下一步處置",
    CASE_ACTION_TYPE_CONTAINMENT: "圍堵措施",
    CASE_ACTION_TYPE_CORRECTION: "立即矯正",
...
CASE_ACTION_STATUS_COMPLETED = "已完成"
CASE_ACTION_STATUS_CANCELLED = "已取消"
CASE_ACTION_EXECUTION_STATUSES: tuple[str, ...] = (
    CASE_ACTION_STATUS_PLANNED,
    CASE_ACTION_STATUS_IN_PROGRESS,
    CASE_ACTION_STATUS_COMPLETED,
    CASE_ACTION_STATUS_CANCELLED,
)
CASE_ACTION_OPEN_STATUSES: tuple[str, ...] = (
    CASE_ACTION_STATUS_PLANNED,
    CASE_ACTION_STATUS_IN_PROGRESS,
)

ACTION_VERIFICATION_NOT_APPLICABLE = "不適用"
ACTION_VERIFICATION_NOT_REQUIRED = "不需要"
ACTION_VERIFICATION_PENDING = "待驗證"
ACTION_VERIFICATION_EFFECTIVE = "有效"
ACTION_VERIFICATION_INEFFECTIVE = "無效"
ACTION_VERIFICATION_INCONCLUSIVE = "無法判定"
ACTION_VERIFICATION_RESULTS: tuple[str, ...] = (
...
CASE_ACTION_LEGACY_SOURCE_NEXT_ACTION = "anomaly_actions"
CASE_ACTION_LEGACY_SOURCE_CORRECTIVE_ACTION = "corrective_actions"
...
# Attachment metadata contract v2 is intentionally separate from the original
# table-creation marker.  Existing databases may already have the v1 marker
# while still missing the Phase 2 relationship/system columns.
...
ANOMALY_AUDIT_EIGHT_D_REVIEWED = "EIGHT_D_REVIEWED"
...
RETIRED_WORKBENCH_AUDIT_ACTIONS: frozenset[str] = frozenset(
    {
        ...
        ANOMALY_AUDIT_EIGHT_D_REVIEWED,
    }
)


def is_retired_workbench_audit_action(action: str | None) -> bool:
    return str(action or "").strip() in RETIRED_WORKBENCH_AUDIT_ACTIONS
...
ANOMALY_ATTACHMENT_CATEGORY_SUPPLIER_8D = "Supplier 8D"
ANOMALY_ATTACHMENT_CATEGORY_CORRECTIVE_ACTION = "Corrective Action Evidence"
ANOMALY_ATTACHMENT_CATEGORY_EFFECTIVENESS = "Effectiveness Evidence"
ANOMALY_ATTACHMENT_CATEGORY_SPECIFICATION = "Specification / Reference"
ANOMALY_ATTACHMENT_CATEGORY_SUPPLIER_AUDIT = "Supplier Audit Evidence"
ANOMALY_ATTACHMENT_CATEGORY_OTHER = "Other"
ANOMALY_ATTACHMENT_CATEGORIES: tuple[str, ...] = (
...
ANOMALY_ATTACHMENT_CATEGORY_LABELS: dict[str, str] = {
    ANOMALY_ATTACHMENT_CATEGORY_EVIDENCE: "證據",
    ANOMALY_ATTACHMENT_CATEGORY_NG_PHOTO: "不良照片",
    ANOMALY_ATTACHMENT_CATEGORY_FA_REPORT: "FA 報告",
    ANOMALY_ATTACHMENT_CATEGORY_SUPPLIER_8D: "Supplier 8D",
    ANOMALY_ATTACHMENT_CATEGORY_CORRECTIVE_ACTION: "矯正措施證據",
    ANOMALY_ATTACHMENT_CATEGORY_EFFECTIVENESS: "有效性驗證證據",
    ANOMALY_ATTACHMENT_CATEGORY_SPECIFICATION: "規格／參考文件",
    ANOMALY_ATTACHMENT_CATEGORY_SUPPLIER_AUDIT: "供應商稽核證據",
    ANOMALY_ATTACHMENT_CATEGORY_OTHER: "其他",
}
