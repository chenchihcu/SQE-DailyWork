...
$null = Read-SqeDailyWorkHookInput

@"
SQE DailyWork Claude automation context:
- This repo is a single-user local PySide6 + SQLite Supplier Quality Engineering desktop tool.
- Keep changes repo-local; do not modify global Claude/Codex settings for SQE DailyWork work.
