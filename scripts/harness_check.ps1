...
Require-Text "AGENTS.md" "UI visual closure gate" "AGENTS UI visual closure gate"
Require-Text "AGENTS.md" "not verified" "AGENTS not verified vs residual risk"
...
Require-Text ".claude\hooks\sqe-dailywork-route-keywords.json" "scripts\\qt_visual_probe.py" "prompt visual reminder"
Require-Text ".claude\hooks\sqe-dailywork-route-keywords.json" "MCP is deferred" "prompt MCP deferred reminder"
...
Require-Text ".claude\skills\sqe-dailywork-change-router\SKILL.md" "UI visual closure gate" "change router UI visual closure gate"
Require-Text ".claude\skills\sqe-dailywork-change-router\SKILL.md" "repeat-issues-management" "change router repeat-issues target mapping"
Require-Text ".claude\skills\sqe-dailywork-visual-qa\SKILL.md" "name: sqe-dailywork-visual-qa" "visual skill name"
Require-Text ".agents\skills\sqe-dailywork-visual-qa\references\visual_qa_checklist.md" "repeat-issues-management" "visual qa repeat-issues target"
Require-Text ".agents\skills\sqe-dailywork-visual-qa\references\visual_qa_checklist.md" "No false done" "visual qa no false done section"
Require-Text ".claude\rules\visual_evidence_rules.md" "Playwright" "visual Playwright guardrail"
...
Require-Text ".gitignore" "logs/" "runtime logs directory is ignored"
Require-Text ".gitignore" "brain/" "Gemini scaffolding is ignored"
Require-Text ".gitignore" ".opencode/" "OpenCode tool state is ignored"
Require-Text ".gitignore" "button_audit_report.md" "root button audit report is ignored"
