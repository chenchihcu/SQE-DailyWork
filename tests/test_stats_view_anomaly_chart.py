...
from PySide6.QtCharts import QBarCategoryAxis, QHorizontalStackedBarSeries, QValueAxis
...
class StatsViewAnomalyChartTests(unittest.TestCase):
    ...
    def _build_widget(
        ...
        *,
        ...
        with patch("services.event_service.get_monthly_stats", return_value=summary), \
             patch("services.event_service.get_anomaly_trend", return_value=[]), \
    ...
    def test_stats_view_chart_uses_dashed_gridline_and_clean_layout(self) -> None:
        ...
        # Should not have any scroll areas in the new compact layout
        self.assertEqual(len(widget.findChildren(QScrollArea)), 0)
