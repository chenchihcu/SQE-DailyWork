...
- Full verify: `scripts/verify.ps1 -Profile Full` includes NCR tests + pytest module regressions after unittest discover; run backgrounded (~15–20 min). Evidence: `scratch/verify-full-log-final.txt`.
